  ...
  stages {
    ...
    stage('Login to ECR') {
      steps {
        ...
        withCredentials([usernamePassword(credentialsId: 'aws-credentials', usernameVariable: 'AKIA3AVWGHZEK3DJ6OF4', passwordVariable: 'HRWHS8rS0c8nIoKw7ReouwtpdmBZlPOLDCZnG7FK')]) {
          sh '''
