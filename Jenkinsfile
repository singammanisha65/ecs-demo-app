  ...
  stages {
    ...
    stage('Login to ECR') {
      steps {
        ...
        withCredentials([usernamePassword(credentialsId: 'aws-credentials', usernameVariable: 'AKIA3AVWGHZEILNTTD6E', passwordVariable: '3CZKrXMgoOIsjqqKr3z1Fh0NCfEUhSNHjTZWIziy')]) {
          sh '''
